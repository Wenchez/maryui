<div>
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-8 my-8 px-2 min-h-[60vh]">
        @forelse ($products as $product)
            <livewire:products.product-view-card :product="$product" wire:key="product-{{ $product->product_id }}" />
        @empty
